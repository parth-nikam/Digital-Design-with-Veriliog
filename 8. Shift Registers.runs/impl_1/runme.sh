...
HD_PWD='D:/Parth/8. Shift Registers/8. Shift Registers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SISO_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SISO_tb.tcl -notrace
