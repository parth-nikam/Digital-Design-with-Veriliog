...
HD_PWD='D:/Parth/8. Shift Registers/8. Shift Registers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SISO_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SISO_tb.tcl
