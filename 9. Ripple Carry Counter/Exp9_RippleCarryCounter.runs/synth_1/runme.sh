...
HD_PWD='D:/Parth/Exp9_RippleCarryCounter/Exp9_RippleCarryCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rippleCarryCounterTestBench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rippleCarryCounterTestBench.tcl
