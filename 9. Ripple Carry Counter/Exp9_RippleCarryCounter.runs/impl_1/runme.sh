...
HD_PWD='D:/Parth/Exp9_RippleCarryCounter/Exp9_RippleCarryCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rippleCarryCounterTestBench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rippleCarryCounterTestBench.tcl -notrace
